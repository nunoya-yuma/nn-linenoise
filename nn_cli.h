...
typedef enum
{
    ...
    NN_CLI__GENERAL_ERROR,       // Errors that are difficult to categorize
                                 // specifically.
    NN_CLI__INVALID_ARGS,        // Input arguments are incorrect.
    NN_CLI__EXCEED_CAPACITY,     // The size limit for arrays, etc. has been
                                 // reached.
    NN_CLI__EXTERNAL_LIB_ERROR,  // Errors in external libraries or tools used
    NN_CLI__PROCESS_COMPLETED,  // It means that the process has been completed,
